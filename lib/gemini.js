 ...
 */
export async function generateProjectSuggestions(apiKey, skills) {
  const prompt = `You are a project ideas generator for a developer portfolio. 
Generate 6 unique, realistic, and highly impressive software projects based on the following tech stack: ${skills.join(', ')}.
Make sure to include a mix of difficulties: 2 simple, 2 medium, 1 complex, and 1 very-complex.
